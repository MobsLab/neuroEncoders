...
SHOCK_CENTER_COLOR = "xkcd:orchid"
SAFE_CENTER_COLOR = "xkcd:periwinkle"
SHOCK_CENTER_PREDICTED = "xkcd:light mauve"
MIDDLE_COLOR_PREDICTED = "xkcd:pale violet"
SAFE_CENTER_PREDICTED = "xkcd:light blue"
